...
| `MENU_NEUMATICOS_TRAZABILIDAD` | Trazabilidad (intervención) |
| `MENU_NEUMATICOS_POSICIONES` | Posiciones |
| `MENU_NEUMATICOS_DANO_NEUMATICO` | Daño neumático |
| `MENU_NEUMATICOS_DANO_LLANTA` | Daño llanta |
