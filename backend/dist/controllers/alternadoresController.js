...
export const createAlternador = async (req, res) => {
    try {
        ...
        if (id_tipo_comp_alternador_19) {
            const tipoExists = await pool.query('SELECT id_tipo_comp_alternador_30 FROM tbl_30_tipo_comp_alternador WHERE id_tipo_comp_alternador_30 = $1', [id_tipo_comp_alternador_19]);
