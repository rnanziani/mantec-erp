...
export const getResponsableById = async (req, res) => {
    try {
        const { id } = req.params;
        const result = await pool.query(`SELECT idresponsableentrega_08, nombreresponsableentrega_08, apaternoresponsableentrega_08, amaternoresponsableentrega_08
       FROM ${TABLA_RESPONSABLE} WHERE idresponsableentrega_08 = $1`, [id]);
...
export const createResponsable = async (req, res) => {
    try {
        ...
        const result = await pool.query(`INSERT INTO ${TABLA_RESPONSABLE} (nombreresponsableentrega_08, apaternoresponsableentrega_08, amaternoresponsableentrega_08)
       VALUES ($1, $2, $3)
...
export const updateResponsable = async (req, res) => {
    try {
        ...
        const result = await pool.query(`UPDATE ${TABLA_RESPONSABLE}
...
export const deleteResponsable = async (req, res) => {
    try {
        ...
        const checkPrendas = await pool.query('SELECT idasignacionmain_09 FROM tbl_09_asignacion_main WHERE idresponsableentrega_09 = $1 LIMIT 1', [id]);
        ...
        const result = await pool.query(`DELETE FROM ${TABLA_RESPONSABLE} WHERE idresponsableentrega_08 = $1 RETURNING idresponsableentrega_08`, [id]);
