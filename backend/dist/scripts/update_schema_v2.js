    ...
    `);
      ...
      `);
        ...
        for (const tipo of tipos) {
            const res = await client.query('SELECT id_tipo_transaccion_25 FROM tbl_25_tipo_transaccion WHERE cod_accion_25 = $1', [tipo.cod]);
            if (res.rows.length === 0) {
                await client.query('INSERT INTO tbl_25_tipo_transaccion (descripcion_25, cod_accion_25, valor_accion_25) VALUES ($1, $2, $3)', [tipo.desc, tipo.cod, tipo.valor]);
