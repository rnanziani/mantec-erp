-- Permiso de reportes de repuestos dañados
-- En DBeaver: Alt+X. Asigna a rnanziani y a niveles que ya tienen MENU_REPUESTOS_DANADOS.

INSERT INTO tbl_05_permiso (nombre_permiso_05, descripcion_05, orden_05)
SELECT v.nombre, v.descripcion, v.orden
FROM (VALUES
  ('MENU_REPUESTOS_DANADOS_REPORTES', 'Reportes de recepcion, proveedor e instalados', 9180)
...
WHERE LOWER(u.email) = LOWER('rnanziani@gmail.com')
  AND p.nombre_permiso_05 = 'MENU_REPUESTOS_DANADOS_REPORTES'
  AND NOT EXISTS (
...
FROM tbl_05_permiso
WHERE nombre_permiso_05 = 'MENU_REPUESTOS_DANADOS_REPORTES';
